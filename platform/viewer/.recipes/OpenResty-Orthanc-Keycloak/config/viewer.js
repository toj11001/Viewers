window.config = {
  ...
  servers: {
    ...
    dicomWeb: [
      {
        name: 'Orthanc',
        wadoUriRoot: 'https://34.107.27.6/orthanc/wado',
        qidoRoot: 'https://34.107.27.6/orthanc/dicom-web',
        wadoRoot: 'https://34.107.27.6/orthanc/dicom-web',
  ...
  oidc: [
    {
      ...
      redirect_uri: 'https://34.107.27.6/callback', // `OHIFStandaloneViewer.js`
